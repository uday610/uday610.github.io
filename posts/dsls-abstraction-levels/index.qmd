...
In contrast, a non-tiled version needs a full row of A and a full column of B to produce a single element of C, and every element it loads feeds exactly one multiply-accumulate operation. The tiled version does far more math per element loaded from global memory.
