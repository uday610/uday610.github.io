...
![Approximate DSL hierarchy: These DSLs do not form a perfectly linear ladder. Several can span neighboring bands depending on the features used and the level of control the author chooses to exercise. For example, TileLang is shown in two neighboring bands in the diagram.](images/dsl_band.png){width=90%}
