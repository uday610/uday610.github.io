...
![Disaggregated serving flow: the router sends prompts to the prefill pool, the KV cache transfers to the decode pool over the fast fabric, and generated tokens return through the router. The autoscaler adjusts the xP:yD ratio.](images/disaggregation.png){#fig-diflow width=90%}
...
In the first half of 2026, I have seen a string of announcements and trends around heterogeneous disaggregated inference. I find these really interesting, and I am curious how they all play out. Let me list a few of them.
